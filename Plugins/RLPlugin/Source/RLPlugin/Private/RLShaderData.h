...
static TMap< FString, FString > g_kSkinMap =
{
    ...
    // Roughness
    { "Add Cavity","Add Cavity"},
    { "Original Roughness Strength","Original Roughness Strength"},
...
static TMap< FString, FString > g_kHeadMap =
{
    ...
    { "Edge Roughness Multiplier", "Edge Roughness Multiplier" },
    // Specular Metallic
    //{ "_Specular", "Head Specular" }, // UE head specular change to 0.5, https://app.asana.com/0/41456831439229/1207630541448626
    { "_Specular", "Head Specular" }, // #0094191
    { "SSS Metallic Threshold", "Metallic SSS Threshold" },
...
static TMap< FString, FString > g_kEyeOcclusionMap =
{
...
static TMap< FString, FString > g_kEyeOcclusionPlusMap =
{
    // Blur
    { "Display Blur Range", "DisplayBlurRange" },
    { "Blur Color", "Blur Color" },
    { "Blur Strength", "Blur Size" },

    { "Top Blur Range",                     "Top Blur Range" },
    { "Top Blur Contrast",                  "TopBlur Hardness" },
    { "Top Blur Edge Feadout Contrast",     "TopBlurBorder Hardness" },
    { "Bottom Blur Range",                  "Bottom Blur Range" },
    { "Bottom Blur Contrast",               "BottomBlur Hardness" },
    { "Bottom Blur Edge Fadeout Contrast",  "BottomBlurBorder Hardness" },
    { "Outer Blur Range",                   "Outer Blur Range" },
    { "Outer Blur Contrast",                "OuterBlur Hardness" },
    { "Outer Blur Edge Fadeout Contrast",   "OuterBlurBorder Hardness" },
    { "Inner Blur Duct Range",              "Inner Blur Duct Range" },
    { "Inner Blur Contrast",                "InnerBlur Hardness" },
    { "Inner Blur Edge Fadeout Contrast",   "InnerBlurBorder Hardness" },

    // shadow
    { "Shadow Color",                       "ShadowTint" },
    { "Shadow Strength",                    "ShadowMultiply" },
    { "Shadow Top Range",                   "Shadow Top Range" },
    { "Shadow Top Contrast",                "TopShadow Hardness" },
    { "Shadow Top Edge Fadeout Contrast",   "TopShadowBorder Hardness" },
    { "Shadow Bottom Range",                "Shadow Bottom Range" },
    { "Shadow Bottom Contrast",             "BottomShadow Hardness" },
    { "Shadow Bottom Edge Fadeout Contrast","BottomShadowBorder Hardness" },
    { "Shadow Inner Range",                 "Shadow Inner Range" },
    { "Shadow Inner Contrast",              "InnerShadow Hardness" },
    { "Shadow Inner Edge Fadeout Contrast", "InnerShadowBorder Hardness" },
    { "Shadow Outer Range",                 "Shadow Outer Range" },
    { "Shadow Outer Contrast",              "OuterShadow Hardness" },
    { "Shadow Outer Edge Fadeout Contrast", "OuterShadowBorder Hardness" },
...
static TMap< FString, FString > g_kTearLinePlusMap =
{
    { "Depth Offset", "DepthOffset" },
    { "Detail Amount", "DetailAmount" },
    { "Detail U Tiling", "DetailUTiling" },
    { "Detail V Tiling", "DetailVTiling" },
    { "Micro Normal Strength", "MicroNormalStrength" },
    { "Micro Normal Scale", "MicroTiling" },
    { "Edge Fadeout", "FadeStart" },
    { "_Roughness", "Roughness" },
    { "_Opacity", "Opacity" },
};

static TMap< FString, TArray< FString > > g_kEyeOcclusionRangeMap =
{
    { "Top Blur Range",        {"TopBlurBorder Radius",      "TopBlur Radius"} },
    { "Bottom Blur Range",     {"BottomBlurBorder Radius",   "BottomBlur Radius"} },
    { "Outer Blur Range",      {"OuterBlurBorder Radius",    "OuterBlur Radius"} },
    { "Inner Blur Duct Range", {"InnerBlurBorder Radius",    "InnerBlur Radius"} },
    { "Shadow Top Range",      {"TopShadowBorder Radius",    "TopShadow Radius"} },
    { "Shadow Bottom Range",   {"BottomShadowBorder Radius", "BottomShadow Radius"} },
    { "Shadow Inner Range",    {"InnerShadowBorder Radius",  "InnerShadow Radius"} },
    { "Shadow Outer Range",    {"OuterShadowBorder Radius",  "OuterShadow Radius"} },
};
...
public:
    ...
    TMap< FString, TArray< float > > m_kRangeParameter;
